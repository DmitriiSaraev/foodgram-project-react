# Generated by Django 3.2 on 2023-05-08 15:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200, unique=True, verbose_name='Наименование')),
                ('color', models.CharField(max_length=7, unique=True, validators=[recipes.models.validate_hex_color], verbose_name='Цвет')),
